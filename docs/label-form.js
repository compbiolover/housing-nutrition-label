...
window.LabelForm = (function () {
  ...
  var FIELDS = [
    // min matches housing_label.enrich.durability.EARLIEST_PLAUSIBLE_YEAR. It was
    // 1850, which is stricter than anything the scorer applies and which no
    // reader could have talked their way past: the panel writes an OBSERVED year
    // straight into this field, so a colonial home — Connecticut alone records
    // 8,375 built before 1800 — arrived pre-filled and marked :invalid, with a
    // stepper that could not reach its own value.
    { key: "year_built", label: "Year built", type: "number",
      attrs: 'min="1600" max="2030" step="1" placeholder="e.g. 1998"' },
