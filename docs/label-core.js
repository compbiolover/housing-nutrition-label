...
window.LabelCore = (function () {
  ...
  var DIM_ABOUT = {
    ...
    air_quality: "The county's ambient air quality — annual fine-particulate (PM2.5) and ozone from the CDC Tracking model, plus the EPA radon zone — scored against the national distribution of US counties. Higher means cleaner, safer air.",
