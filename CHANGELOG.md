...
* **label:** stop paying for a slow dataset, and return the label without it ([#300](https://github.com/compbiolover/housing-nutrition-label/issues/300)) ([f0cbdc3](https://github.com/compbiolover/housing-nutrition-label/commit/f0cbdc37e3d8f73b1bc90cf772a319c8e414cc2d))
...
* **label:** take the label off the screen — print it, or save the page ([#291](https://github.com/compbiolover/housing-nutrition-label/issues/291)) ([cc55b84](https://github.com/compbiolover/housing-nutrition-label/commit/cc55b841c5581d7368c24299402423833fa528cc))

## [0.2.4](https://github.com/compbiolover/housing-nutrition-label/compare/v0.2.3...v0.2.4) (2026-08-12)


### Features

* **legal:** say what the label isn't, everywhere it's read ([#289](https://github.com/compbiolover/housing-nutrition-label/issues/289)) ([6a82c78](https://github.com/compbiolover/housing-nutrition-label/commit/6a82c78dcb57bfbef6d027d4671705b18f6819d6))
...
* **batch:** score a whole portfolio in one pass, with no network ([#278](https://github.com/compbiolover/housing-nutrition-label/issues/278)) ([e5c222f](https://github.com/compbiolover/housing-nutrition-label/commit/e5c222f38cfbcf994b9441173d0484793d237c2b))
...
* **density:** stop re-resolving the parcel, and take /presets off the click ([#270](https://github.com/compbiolover/housing-nutrition-label/issues/270)) ([639a443](https://github.com/compbiolover/housing-nutrition-label/commit/639a4430e8feff8930475ca1967f7cefcf915186))
...
* bring the scored label into view on a phone ([#218](https://github.com/compbiolover/housing-nutrition-label/issues/218)) ([3169671](https://github.com/compbiolover/housing-nutrition-label/commit/31696713d9bc29dbffa4e50574d9a878c389abd1))
...
* re-light the page title in dark mode ([#212](https://github.com/compbiolover/housing-nutrition-label/issues/212)) ([8381788](https://github.com/compbiolover/housing-nutrition-label/commit/83817889859d09441647909cb787f81e8858551f))

## [0.1.66](https://github.com/compbiolover/housing-nutrition-label/compare/v0.1.65...v0.1.66) (2026-07-26)


### Bug Fixes

* name the scored place by the address that was entered ([#210](https://github.com/compbiolover/housing-nutrition-label/issues/210)) ([9b80e8d](https://github.com/compbiolover/housing-nutrition-label/commit/9b80e8d542d1e84f0abe7346a1b6c9fd6b835be3))
...
* restyle the reference and setup pages ([#205](https://github.com/compbiolover/housing-nutrition-label/issues/205)) ([1134848](https://github.com/compbiolover/housing-nutrition-label/commit/11348484c47a4d303b0846a792951719bffd9fb3))

## [0.1.63](https://github.com/compbiolover/housing-nutrition-label/compare/v0.1.62...v0.1.63) (2026-07-24)


### Features

* accessibility and readability follow-ups ([#204](https://github.com/compbiolover/housing-nutrition-label/issues/204)) ([2a312cf](https://github.com/compbiolover/housing-nutrition-label/commit/2a312cf5235fe8b8bddb4f7fa38c4d178f613f83))
* accessibility pass and Bureau Blue (Harbor) palette ([#202](https://github.com/compbiolover/housing-nutrition-label/issues/202)) ([68668fc](https://github.com/compbiolover/housing-nutrition-label/commit/68668fc8be67a743758b983e5ddfe317fa0d2c4c))

## [0.1.62](https://github.com/compbiolover/housing-nutrition-label/compare/v0.1.61...v0.1.62) (2026-07-24)


### Bug Fixes

* group address-form buttons so none orphan-wraps ([#200](https://github.com/compbiolover/housing-nutrition-label/issues/200)) ([fd80b65](https://github.com/compbiolover/housing-nutrition-label/commit/fd80b652571acecace94ff4195d7fb7ce60bd56f))

## [0.1.61](https://github.com/compbiolover/housing-nutrition-label/compare/v0.1.60...v0.1.61) (2026-07-21)


### Features

* **docs:** auto-sync Setup & Reference pages with the scoring engine ([#196](https://github.com/compbiolover/housing-nutrition-label/issues/196)) ([28a21fa](https://github.com/compbiolover/housing-nutrition-label/commit/28a21fa539579f58916eac858e97b02c1b00ff11))

## [0.1.60](https://github.com/compbiolover/housing-nutrition-label/compare/v0.1.59...v0.1.60) (2026-07-21)


### Features

* pre-score non-residential hint + Google Autocomplete typeahead (session tokens) ([#193](https://github.com/compbiolover/housing-nutrition-label/issues/193)) ([9f31845](https://github.com/compbiolover/housing-nutrition-label/commit/9f318453854226514703435e7766bb28616e9744))


### Bug Fixes

* code-review findings — residential screen override + non-residential flag on /place failure ([#195](https://github.com/compbiolover/housing-nutrition-label/issues/195)) ([5ab940b](https://github.com/compbiolover/housing-nutrition-label/commit/5ab940b4a4784ab6ef1128eb3166cbf0237cd1fb))
