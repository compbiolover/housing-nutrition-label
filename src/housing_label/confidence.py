...
CONFIDENCE_NOTES = {
    "resilience": "Parcel-level flood zone + seismic; wildfire resolves at county level here; construction and above-code feature credits are calibrated to published FEMA, IBHS, NFPA and PEER-CEA data — a few recovery-side bonuses, such as solar, backup power and leak detection, are still first-pass estimates.",
